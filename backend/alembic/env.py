...
def include_name(name, type_, reflected, compare_to):
...
def run_migrations_offline() -> None:
    ...
    context.configure(url=url, target_metadata=target_metadata, literal_binds=True, dialect_opts={"paramstyle": "named"}, include_name=include_name)
